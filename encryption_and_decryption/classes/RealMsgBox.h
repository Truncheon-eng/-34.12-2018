...
class RealMsgBox : public IMsgBox {
  public:
    /**
     * @brief метод, вызываемый аттрибутом m_msg_box класса MainFrame для
     * создания окна-сообщения.
     * @param message текст, выводящийся в окне-сообщении.
     * @param caption текст, выводящийся в верхней панели окна.
     ...
     * типа int.
     */
    int Show(const wxString &message, const wxString &caption, int style,
             wxWindow *parent) override;
};
