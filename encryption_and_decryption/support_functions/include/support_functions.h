...
/**
 * @brief функция, реализующая g-преобразование блока длиной 32 бита. Для этого преобразования необходим только ключ, соответствующий
 * определённой итерации и сам блок, над которым будет происходить преобразование.
 * 
 * @param half_of_block 32-ух битный блок, к которому применяется g-преобразование.
 * 
